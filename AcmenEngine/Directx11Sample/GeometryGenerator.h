...
public:
	...
	{
		Vertex( ){ }
		Vertex( const XMFLOAT3& position, const XMFLOAT3& normal, const XMFLOAT3& tangent, const XMFLOAT2& texture )
			: Position( position ), Normal( normal ), Tangent( tangent ), Texture( texture ) { }
		Vertex(
