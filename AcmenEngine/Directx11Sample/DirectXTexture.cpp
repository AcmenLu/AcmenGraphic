#ifndef _DIRECTXTEXTURE_H
#define _DIRECTXTEXTURE_H
...
class DirectXTexture: public DirectXBase
{
private:
...
public:
	DirectXTexture( ): mVertexBuffer( 0 ),
...
bool DirectXTexture::BuildGeometryBuffers( )
{
...
bool DirectXTexture::BuildShader( )
{
	DWORD shaderFlags = 0;
...
bool DirectXTexture::InitDirectX3D( )
{
	DirectXBase::InitDirectX3D( );
	return OnResize( );
}

bool DirectXTexture::OnResize( )
{
...
void DirectXTexture::OnUpdate( float elapse )
{
